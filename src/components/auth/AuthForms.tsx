  ...
  return (
    <Card className='w-full max-w-md mx-auto bg-white shadow-lg'>
      <CardHeader className='text-center bg-amber-50 rounded-t-xl'>
        <CardTitle className='text-2xl font-bold text-amber-800'>{t("auth.welcome")}</CardTitle>
        <CardDescription className='text-amber-700'>
          {defaultTab === "login" ? t("auth.loginToAccount") : t("auth.createAccount")}
        </CardDescription>
      </CardHeader>
      <Tabs defaultValue={defaultTab} className='w-full'>
        <TabsList className='grid grid-cols-2 mt-4 mx-4'>
